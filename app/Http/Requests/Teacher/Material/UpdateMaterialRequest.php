...
class UpdateMaterialRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'video_url' => ['nullable', 'url', 'regex:/youtube\.com|youtu\.be|drive\.google\.com/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'sub_materials.*.video_url.url' => 'Format URL video sub-materi tidak valid',
            'sub_materials.*.video_url.regex' => 'URL video sub-materi harus dari YouTube atau Google Drive',
            'case_title.required' => 'Judul studi kasus wajib diisi',
